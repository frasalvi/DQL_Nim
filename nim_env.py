...
class NimEnv:
    ...
    def step(self, action):
        ...
        # move some stuff before the assertions below to allow us to "cleanly" catch the exception
        self.prec_state = self.last_state.copy() if self.last_state else None
        self.prec_action = self.last_action
        self.last_state = self.heaps.copy()
